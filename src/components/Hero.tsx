        ...
        <div className="flex w-full overflow-hidden mask-gradient">
          ...
          >
            ...
            {[...partners, ...partners].map((partner, index) => (
              <div
                key={index}
                // Increased height from h-8/h-10 to h-12/h-16 for larger logos
                className="h-12 sm:h-16 w-auto text-gray-600 hover:text-[#80e01a] transition-colors duration-300 flex items-center gap-2 group"
              >
                <div className="h-full w-auto aspect-square">
                  {partner.icon}
                </div>
                {/* Name span removed as requested */}
              </div>
            ))}
          </motion.div>
        </div>
